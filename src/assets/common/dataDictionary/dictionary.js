...
export default {
    ...
    imgstatusArr: [
        ...
        {
            value: "ERROR", label: "异常",// "异常"
        },
        {
            value: "SYNCING", label: "同步中", // "同步中"
        },
    ],
    // 镜像管理 type
    // 枚举: ISO,GVM
    ...
    imageFromArr: [
        {
            value: "UPLOAD", label: "上传", // "上传"
        },
        {
            value: "MACHINE_MAKE", label: "云服务器制作",// "云服务器制作"
        },
        {
            value: "SHARE_CHANGE", label: "共享镜像转换",// "共享镜像转换"
        },
        {
            value: "PRIVATE_CHANGE", label: "私有镜像转换",// "私有镜像转换"
        },
    ],
    ...
    operateLogTypeList: [
        {
            value: "IMAGE", label: "镜像管理", // "镜像管理"
        },
        {
            value: "CLUSTER", label: "集群管理", // "集群管理"
        },
        {
            value: "VDC", label: "VDC管理", // "VDC管理"
        },
        {
            value: "ZONE", label: "可用区管理", // "可用区管理"
        },
        {
            value: "ORG", label: "组织管理", // "组织管理"
        },
    ],
    ...
    // 枚举备注: IMAGE_UPLOAD("上传镜像"), IMAGE_SYNC("镜像同步"), IMAGE_CREATE_TEMPLATE("生成模板镜像"), 
    ...
    imageActionList: [
        {
            value: "IMAGE_UPLOAD", label: "上传镜像", // "上传镜像"
        },
        {
            value: "IMAGE_SYNC", label: "镜像同步", // "镜像同步"
        },
        {
            value: "IMAGE_CREATE_TEMPLATE", label: "生成模板镜像", // "生成模板镜像"
        },
        {
            value: "IMAGE_MODIFY", label: "编辑镜像", // "编辑镜像"
        },
        {
            value: "IMAGE_PRIVATE_TO_SHARE", label: "私有镜像提升为共享镜像", // "私有镜像提升为共享镜像"
        },
        {
            value: "IMAGE_SHARE_TO_PUBLIC", label: "共享镜像提升为公共镜像", // "共享镜像提升为公共镜像"
        },
        {
            value: "IMAGE_MAKE", label: "制作镜像", // "制作镜像"
        },
        {
            value: "IMAGE_CREATE_GVM_FILE", label: "生成镜像文件", // "生成镜像文件"
        },
        {
            value: "IMAGE_ERROR_SYNC", label: "镜像异常-同步镜像", // "镜像异常-同步镜像"
        },
        {
            value: "IMAGE_DELETE", label: "删除镜像", // "删除镜像"
        },
        {
            value: "IMAGE_DOWNLOAD", label: "镜像下载", // "镜像下载"
        }
    ],
    ...
    operateLogStatusList: [
        {
            value: "SUCCESS", label: "成功", // "成功"
        },
        {
            value: "FAIL", label: "失败", // "失败"
        },
        {
            value: "RUNNING", label: "执行中", // "执行中"
        }
    ],
