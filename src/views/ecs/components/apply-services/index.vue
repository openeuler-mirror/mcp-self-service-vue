<template>
  <div class="drawer-content">
    ...
    <!-- bindTemplateModal -->
    <bindTemplateModal
      :visible.sync="showbindtemplateModal"
...
import bindTemplateModal from "../bindTemplateModal/bindTemplateModal.vue";
export default {
  components: {
    footBtn,
    selectTemplate,
  ...
  methods: {
    ...
    templateConfirm(rows) {
      ...
      this.formTemplate.templateName = template.templateName;
      this.formTemplate.template = template.templateId;
