...
export default {
  ...
  methods: {
            ...
            .catch((err) => {
              if (err.type === "slave") {
                this.$confirm(
                  ...
                  window.location.href = `https://${err.ip}:5000/portal/#/login`;
                });
              }
              this.loading = false;
            });
    ...
    setUserInfo() {
      ...
      Cookies.set("portal-cname", cname, { expires: 7 });
      Cookies.set("portal-cpwd", cpwd, { expires: 7 });
    ...
    getUserInfo() {
      ...
      if (document.cookie.length > 0 && this.pwdChecked) {
        const cname = Cookies.get("portal-cname");
        const cpwd = Cookies.get("portal-cpwd");
    ...
    clearCookie() {
      Cookies.set("portal-cname", "");
      Cookies.set("portal-cpwd", "");
